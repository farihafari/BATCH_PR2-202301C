...
?>
        <form action="shoping-cart.php" method="post">
            <input type="hidden" name="proId" value="<?php echo $productRow['product_id']?>">
            <input type="hidden" name="proName" value="<?php echo $productRow['product_name']?>">
            <input type="hidden" name="proImage" value="<?php echo $productRow['product_image']?>">
            <input type="hidden" name="proPrice" value="<?php echo $productRow['product_price']?>">
            <div class="row">
                        ...
                        <div class="wrap-slick3 flex-sb flex-w">
                            ...
                            <div class="slick3 gallery-lb">
                                <div class="item-slick3"
                                    data-thumb="<?php echo $imageProAdress.$productRow['product_image']?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="<?php echo $imageProAdress.$productRow['product_image']?>"
                                            alt="IMG-PRODUCT">

                                        <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                            href="<?php echo $imageProAdress.$productRow['product_image']?>">
                                ...
                                <div class="item-slick3"
                                    data-thumb="<?php echo $imageProAdress.$productRow['product_image']?>">
                                    <div class="wrap-pic-w pos-relative">
                                        <img src="ima<?php echo $imageProAdress.$productRow['product_image']?>"
                                            alt="IMG-PRODUCT">
                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2">
                            PKR: <?php echo $productRow['product_price']?>
                        </span>
